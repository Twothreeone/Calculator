...
public class SmartScroller implements AdjustmentListener
{
	 ...
	 *            indicates which JScrollBar to monitor. Valid values are HORIZONTAL and VERTICAL.
	 * @param viewportPosition
	 *            indicates where the viewport will normally be positioned as data is added. Valid
